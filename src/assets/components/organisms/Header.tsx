...
import { Flex, Heading, Link as ChaLink, Box, useDisclosure} from "@chakra-ui/react";
...
export const Header:FC = memo(() =>{
    ...
    return(
        <Flex as="nav" bg="#62A8A8" color="gray.50" padding="30px" align="center" justify="space-between" alignItems="flex-end">
            ...
            {/* PC size */}
            <Flex display={{base:"none", md:"flex"}} padding="0 5px" fontSize="sm" flexGrow={2}>
